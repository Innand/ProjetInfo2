...
int biblio(int chaine)
{
    ...
    else if(chaine==1)
    {
        ...
        bibcolli=load_bitmap("pics2/bibliotheque2_colli.jpg", NULL);
    }

    else if(chaine==2)
    {
        bib=load_bitmap("pics3/bibliotheque3.jpg", NULL);
        bibcolli=load_bitmap("pics3/bibliotheque3_colli.jpg", NULL);
    }
    ...
    if(mouse_b&2)
    {
        ...
        else if(getr(couleur)<=255 && getr(couleur)>=253 && getg(couleur)>=0 && getg(couleur)<=3 && getb(couleur)>=253 && getb(couleur)<=255)
        {
            choix=5;
        }
        else if(getr(couleur)<=3 && getr(couleur)>=0 && getg(couleur)>=253 && getg(couleur)<=255 && getb(couleur)>=253 && getb(couleur)<=255)
        {
            choix=6;
        }
        else if(getr(couleur)<=3 && getr(couleur)>=0 && getg(couleur)>=0 && getg(couleur)<=3 && getb(couleur)>=0 && getb(couleur)<=3)
        {
            choix=7;
        }
        else if(getr(couleur)<=178 && getr(couleur)>=172 && getg(couleur)>=172 && getg(couleur)<=178 && getb(couleur)>=172 && getb(couleur)<=178)
        {
            choix=8;
        }
        else if(getr(couleur)<=178 && getr(couleur)>=172 && getg(couleur)>=0 && getg(couleur)<=3 && getb(couleur)>=172 && getb(couleur)<=178)
        {
            choix=9;
        }
        else if(getr(couleur)<=178 && getr(couleur)>=172 && getg(couleur)>=172 && getg(couleur)<=178 && getb(couleur)>=0 && getb(couleur)<=3)
        {
            choix=10;
        }
        else if(getr(couleur)<=3 && getr(couleur)>=0 && getg(couleur)>=172 && getg(couleur)<=178 && getb(couleur)>=172 && getb(couleur)<=178)
        {
            choix=11;
        }
        else if(getr(couleur)<=103 && getr(couleur)>=97 && getg(couleur)>=0 && getg(couleur)<=3 && getb(couleur)>=0 && getb(couleur)<=3)
        {
            choix=12;
        }
    }

...
class Graph
{
    public:
        ...
        void ajouter_sommet(bool *fini, bool *fin2, int *cpt);

        void enregistrer_donnees_som();

        void recup_donnees_som();

        void enregistrer_donnees_ar();

        void recup_donnees_ar();
///afficher aretes
void  afficher_aretes();

/// ajouter arete
void ajouter_arete(bool *finn, bool *finn2, bool *gauche, int *cptt,   Sommet *s1, Sommet *s2, int *s);
